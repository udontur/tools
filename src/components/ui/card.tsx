...
function Card({
  ...
  return (
    <div
      ...
      data-size={size}
      className={cn(
        "hover:ring-ring/40 ring-ring/25 group/card flex flex-col gap-6 overflow-hidden rounded-4xl bg-card py-6 text-sm text-card-foreground shadow-md ring-1 has-[>img:first-child]:pt-0 data-[size=sm]:gap-4 data-[size=sm]:py-4 *:[img:first-child]:rounded-t-4xl *:[img:last-child]:rounded-b-4xl hover:-translate-y-1 ease-in-out duration-200 ",
        className
      )}
      {...props}
    />
